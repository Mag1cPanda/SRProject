...
- (NSArray *)viewControllers {
    ...
    CYLBaseNavigationController *nav1 = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:oneVC];
    
    TwoViewController *twoVC = [TwoViewController new];
    CYLBaseNavigationController *nav2 = [[CYLBaseNavigationController alloc]
                                         initWithRootViewController:twoVC];
    
    ThreeViewController *threeVC = [ThreeViewController new];
    CYLBaseNavigationController *nav3 = [[CYLBaseNavigationController alloc]
                                         initWithRootViewController:threeVC];
    
    FourViewController *fourVC = [FourViewController new];
    CYLBaseNavigationController *nav4 = [[CYLBaseNavigationController alloc]
