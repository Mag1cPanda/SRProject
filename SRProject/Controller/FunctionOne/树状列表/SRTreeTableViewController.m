...
@interface SRTreeTableViewController ()
<MYTreeTableViewControllerParentClassDelegate>

@end

@implementation SRTreeTableViewController
...
- (void)refreshTableViewController:(MYTreeTableViewController *)tableViewController {
    NSLog(@"refreshTableViewController");
//    [self requestData];
}
